...
<!--manual setting for google font--> 
    ...
    <?php if ( function_exists( 'ot_get_option' ) ) :if (ot_get_option( 'title_font_link')) :  echo ot_get_option( 'title_font_link' ); endif ; endif; ?>
...
<?php $preload = ot_get_option( 'preloader_set' ); if ($preload == 'show_home') {  ?>
